...
!----------------------------------------------------------------------------
    ...
    call MPI_ALLTOALLV(sendbuf,size_send_chunk,send_displs,MPI_DOUBLE_PRECISION,   &
                       ...
                       comm,ierr)
    if(ierr .ne. 0) write(0,*) 'error flagged in alltoallv yblock_2_zblock1d   myid,ierr:',myid,ierr
...
!----------------------------------------------------------------------------
    ...
    call MPI_ALLTOALLV(sendbuf,size_send_chunk,send_displs,MPI_DOUBLE_PRECISION,   &
                       recvbuf,size_recv_chunk,recv_displs,MPI_DOUBLE_PRECISION,   &
                       comm,ierr)
	if(ierr .ne. 0) write(0,*) 'error flagged in alltoallv zblock_2_yblock1d   myid,ierr:',myid,ierr
