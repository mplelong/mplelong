...
data_file = root_dir + 'output/Tri-Periodic_results'     # xval,yval,zval,t(n),uvw(n,1),uvw(n,2),uvw(n,3),exact(n,1),exact(n,2),exact(n,3)
...
title_string = "computed vs exact soln at arbitrary point: 64^3  L=1 [m] nu=1.d-3 [m2/s]  dt=%.4f  [s] " %(dt)
