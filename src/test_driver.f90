...
integer             :: myid,comm,ierr,numprocs
integer             :: ncid,info,istep
...
character(len=80)          :: runlabel,logfile
...
!!==============================================================================
 ...
 if( myid .eq. 0 .and. ierr==MPI_SUCCESS ) then
  ...
  write(0,*) ' ................        Tengo ',numprocs,' procesadore(s).'
...
!!==============================================================================
 ...
 if(ierr.eq.NF_NOERR) then
  ...
  if(myid==0) write(0,*) ' ................        Hubo un problema durante la creación del archivo netcdf: ',ierr
 endif

 ierr=NF_ENDDEF(ncid)
 if(ierr.eq.NF_NOERR) then
  if(myid==0) write(0,*) ' ................        La salida del modo *define*  fue exitosa.'
 else
  if(myid==0) write(0,*) ' ................        Hubo un error mientras saliendo del modo *define*.'
 endif

 ierr=NF_CLOSE(ncid)
 if(ierr.ne.NF_NOERR .and. myid==0) &
  write(0,*) ' ................        Hubieron problemas tratando de cerrar el archivo netcdf.'
 if(myid==0) write(0,*) ' ................   '
...
!!==============================================================================
 ...
 if(myid==0) write(0,*) ' ................        El resultado debe ser pi: ',x(1)
 if(myid==0) write(0,*) ' ................   '
 if(myid==0) write(0,*) ' ................   '
...
!!==============================================================================
 ...
 if(myid==0) write(0,*) ' ................   '
 if(myid==0) write(0,*) ' ................        factor a random dense matrix '
...
!!==============================================================================
 ...
 if(myid==0) write(0,*) ' ................        Creación del plan vía dfftw_plan_guru_r2r OK ..'
 in(:,:,:) = 0.0
 out(:,:,:)= 0.0
 call dfftw_execute_r2r(forward_plan,in,out)
 if(myid==0) write(0,*) ' ................        Realización del plan vía dfftw_execute_r2r OK ..'
 if(myid==0) write(0,*) ' ................   '
 deallocate(in,out)
...
!!==============================================================================
 ...
 if(myid==0) write(0,*) ' ................   '
 if(myid==0) write(0,*) ' ................   Cerrando MPI ..... '
 if(myid==0) write(0,*) ' ................        MPI está muerto ahora. ',ierr
 if(myid==0) write(0,*) ' ................   '

 if(myid==0) write(0,*) ' ................   '
 if(myid==0) write(0,*) ' ................   '
 if(myid==0) write(0,*) ' ................   =================================================== '
 if(myid==0) write(0,*) ' ................   Me parace que la installacion funciona bien. Adios. '
 if(myid==0) write(0,*) ' ................   =================================================== '
