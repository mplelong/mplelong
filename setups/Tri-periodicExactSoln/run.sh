...
#-------------------------------------------------
# prepare things for Tri-periodicExactSoln test
#-------------------------------------------------
#rm -f input
#ln -s setups/Tri-periodicExactSoln input
#make clean
#make flow.x
#make outdirs
...
"$PYTHON" python_scripts/compare_results.py "$FLOW_SOLVE_ROOT"  # plot comparison of computed vs exact sols
