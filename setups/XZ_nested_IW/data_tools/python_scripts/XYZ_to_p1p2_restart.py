...
# slice index of input file, not needed if input generated by interp_V.py
slice_index = int(sys.argv[4])
...
from_interpolated=False                      # use file naming convention of interp_V.py, i.e. input is slices/3D/vert_horiz_interp.nc
