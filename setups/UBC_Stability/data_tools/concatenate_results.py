...
#--------------------------------------
do_XY=False  ; delete_XY=False
do_XZ=False  ; delete_XZ=False
do_YZ=True   ; delete_YZ=False
do_XYZ=False ; delete_XYZ=False
ES = 151   # end_slice
...
if( do_YZ ):
	...
	end_slice = ES                         # ending time slice    
	inc = 1                                 # time slice increment
	iproc = 0                               # iproc for the YZ plane (depends on x value of YZ plane saved)
