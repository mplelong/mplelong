...
if myid==0: 
 print " concat_XZ_mpi.py running on  %d processors on %s.\n" % (numprocs,name) 
...
#---------------------------------------------------------------------------------------
    cmd = "perl ./concat_XZ_subplane.pl " + str(islice) + " " + str(p1) + " "  + str(p2) + " " + data_dir[0:-1] + " XZ_Y=Y0 " + slice_dir[0:-1] +  " XZ_Y=Y0 " + str(myid) + " " + str(iproc_start) + " " + str(iproc_end) + " " + str(jproc_start) + " " + str(jproc_end)
    print cmd
    os.system(cmd)
    
    cmd = "perl ./concat_XZ_subplane.pl " + str(islice) + " " + str(p1) + " "  + str(p2) + " " + data_dir[0:-1] + " XZ_Y=Y1 " + slice_dir[0:-1] +  " XZ_Y=Y1 " + str(myid) + " " + str(iproc_start) + " " + str(iproc_end) + " " + str(jproc_start) + " " + str(jproc_end)
    print cmd
    os.system(cmd)
